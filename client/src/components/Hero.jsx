  ...
  return (
    <div>
        <div className="flex flex-col md:flex-row flex-wrap bg-gradient-to-r from-[#1F518C] to-[#26BBBF] text-white px-6 md:px-10 lg:px-20 w-full">
          {/* Left Side */}
          <div className='md:w-1/2 flex flex-col items-center justify-center gap-4 py-10 md:py-[10vw] md:mb-[-30px] text-3xl'>
          <div className="text-5xl font-stars font-bold mb-4 text-white">
          <Typewriter
  onInit={(typewriter) => {
    typewriter
